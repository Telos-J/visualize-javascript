...
import { variableDeclarations, ifStatements } from '../../js/parse'
...
function wakeUp() {
    ...
    gsap.to(rightEye, {
        morphSVG:
            'M178.5 176.5C178.5 180.09 175.59 183 172 183C168.41 183 165.5 180.09 165.5 176.5C165.5 172.91 168.41 170 172 170C175.59 170 178.5 172.91 178.5 176.5Z',
    })
    gsap.to(leftEye, {
        morphSVG:
            'M217.5 176.5C217.5 180.09 214.59 183 211 183C207.41 183 204.5 180.09 204.5 176.5C204.5 172.91 207.41 170 211 170C214.59 170 217.5 172.91 217.5 176.5Z',
    })
}
...
function sleep() {
    ...
    gsap.to(rightEye, {
        morphSVG:
            'M178 176.5C178 179 178 179 171.5 179C165 179 165 179 165 176.5C165 174 165 174 171.5 174C178 174 178 174 178 176.5Z',
    })
    gsap.to(leftEye, {
        morphSVG:
            'M217 176.5C217 179 217 179 210.5 179C204 179 204 179 204 176.5C204 174 204 174 210.5 174C217 174 217 174 217 176.5Z',
    })
}
...
export { outputHandler, animateSleep }
